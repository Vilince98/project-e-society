...
<div id="page-wrapper">
	<div class="main-page general">
		...
		<div style="margin-left:890px;"><a href="admin-add-notice.jsp"><button type="button" class="btn btn-info btn-flat btn-pri" ><i class="fa fa-plus" aria-hidden="true"></i>Notice</button></a></div>
