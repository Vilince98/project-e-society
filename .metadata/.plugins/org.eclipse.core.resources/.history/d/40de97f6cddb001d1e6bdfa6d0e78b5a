      ...
      <div class="container py-md-5">
        <div class="cwp4-two row">
          <div class="cwp4-image col-lg-6 pr-lg-5 mb-lg-0 mb-5">
            ...
            <img src="assets/images/contact.jpg" class="img-fluid" alt=""  height="950px" width="500px"/>
          </div>
          <div class="cwp4-text col-lg-6">
            ...
            <ul class="cont-4">
              ...
              <li><span class="fa fa-check"></span>Address: Geeta Society, Ahmedabad - Gujarat</li>
              <li><span class="fa fa-check"></span>Email: eSociety2023.gmail.com</li>
              <li><span class="fa fa-check"></span>Phone: 8849455423</li>
